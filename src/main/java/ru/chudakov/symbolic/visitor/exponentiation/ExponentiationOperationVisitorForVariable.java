...
public class ExponentiationOperationVisitorForVariable implements OperationVisitor {
    private VariableSymbol firstArgument;

    public ExponentiationOperationVisitorForVariable(VariableSymbol firstArgument) {
